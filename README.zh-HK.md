...
# Spring Ant Family
Spring Ant Family 由三個開源倉庫組成，旨在實現 Web 應用的快速開發。  
- **Spring Ant Backend**：Spring Boot 後端（本倉庫）。
- **[Spring Ant Frontend](https://github.com/HKPC-1967/spring-ant-frontend)**：基於 **Ant Design Pro** 的 React 框架，用於快速構建一個**後台管理系統**。
- **[Spring Ant Frontend API Core](https://github.com/HKPC-1967/spring-ant-frontend-api-core)**：當你不使用 **Ant Design Pro** 作為 UI 框架時，可以將核心 TypeScript 程式碼（大約 200 行）複製到你現有的前端項目中，以快速整合 **Spring Ant Backend** API。
